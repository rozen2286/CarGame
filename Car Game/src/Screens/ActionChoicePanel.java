...
public class ActionChoicePanel extends JPanel {
    ...
    private final Float sizeFont;

    private RoundedCornerButton cancelButton;
    private RoundedCornerButton yesButton;
    private RoundedCornerButton noButton;

    /**
     * קונסטרקטור שמאתחל את הפאנל ומוסיף את הכפתורים
    ...
    public ActionChoicePanel(int x, int y) {
        ...
        messages = new String[] {"Are you sure you want to", "leave the game?", "All will be lost!"};
    ...
    /**
     * מתודה שמציירת את הרקע והגבול של הפאנל ומציגה את ההודעות
    ...
    private void addNoButton() {
        noButton = RoundedCornerButton.myButton(WIDTH / 2 - WIDTH_START_BUTTON, HEIGHT - HEIGHT_BUTTON * 2, WIDTH_START_BUTTON, HEIGHT_START_BUTTON, NO_TEXT, colorButton, this);
    ...
    private void addYesButton() {
        yesButton = RoundedCornerButton.myButton(noButton.getX() + WIDTH_START_BUTTON, noButton.getY(), WIDTH_START_BUTTON, HEIGHT_START_BUTTON, YES_TEXT, colorButton, this);
